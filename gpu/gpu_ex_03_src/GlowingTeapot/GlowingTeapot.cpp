...
void initGLSL()
{
	...
	vertexShaderBlur = loadShader(GL_VERTEX_SHADER, "blur.vert");

	fragmentShaderBlur = loadShader(GL_FRAGMENT_SHADER, "blur.frag");
	
	shaderProgramBlur = loadShaderProgram(vertexShaderBlur, fragmentShaderBlur);

	//fragmentShaderBlurHor = loadShader(GL_FRAGMENT_SHADER, "blur_hor.frag");
	//// TODO: Create shader program and assign it to 'shaderProgramBlurHor'
	//shaderProgramBlurHor = loadShaderProgram(vertexShaderBlur, fragmentShaderBlurHor);

	//fragmentShaderBlurVert = loadShader(GL_FRAGMENT_SHADER, "blur_vert.frag");
	//// TODO: Create shader program and assign it to 'shaderProgramBlurVert'
	//shaderProgramBlurVert = loadShaderProgram(vertexShaderBlur, fragmentShaderBlurVert);
	...
	/*teapotTextureLocation = glGetUniformLocation(shaderProgramBlurHor, "texture");
	glUniform1i(teapotTextureLocation, 0);
	if (teapotTextureLocation == -1)
		cout << "ERROR: No such uniform teapot" << endl;

	teapotTextureLocation = glGetUniformLocation(shaderProgramBlurVert, "texture");
